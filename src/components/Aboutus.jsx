    ...
    <section className="py-8 bg-gray-100">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-6">
          {/* Updated Title for consistent design */}
          <Title title={'ABOUT'} />
        ...
        <div className="relative rounded-xl mb-6 border shadow-lg overflow-hidden">
          <img src={about} alt="Banner" className="w-full h-[20vh] lg:h-[40vh] object-cover transition-transform duration-300 hover:scale-105" />
        </div>

        {/* Features Section */}
        <div className="flex flex-wrap justify-center gap-6 pb-4">
          <div className="p-4 w-full sm:w-1/2 md:w-1/4 text-center transition-transform duration-300 hover:scale-105">
