            ...
            <div className="group w-full h-full ">
              <div className="relative h-full">
                <img
                  ...
                  className="w-full lg:h-full  h-[40vh] lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-[#080127] object-cover "
                />
                <h1 className="font-manrope text-[#080127] text-4xl font-bold leading-10 absolute top-11 left-11">
                  Contact us
                </h1>
